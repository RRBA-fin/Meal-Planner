...
- **PWA-kotinäyttöikoni:** repossa on `manifest.webmanifest` ja ikonit — "Lisää aloitusnäyttöön" antaa oman sovelluskuvakkeen (mini-lautasmalli) ja koko ruudun ilman osoitepalkkia. Ei offline-tukea (tehdään myöhemmin tarvittaessa).
- **Ostoslistan koonti:** ainesnimet ja yksiköt normalisoitu niin että sama tavara on aina yhtenä rivinä (esim. kaikki pastat yhtenä "Pastaa"-rivinä, ruisleivät yhteenlaskettuna). Purkeille merkitty koot (tomaattimurska 400 g, tonnikala 150 g, pavut 380 g...) ja ruokakermoihin rasvaraja "(alle 7 %)".
...
- **Pakkauspohjainen ostoslista:** keskeiset raaka-aineet listautuvat kaupan pakkauksina grammojen sijaan, aina ylöspäin pyöristäen (jauheliha 400 g, broilerin suikaleet 350 g, fileet 450 g, pasta 400 g, tortillat 6 kpl/pkt, kananmunat kennoittain...). Kun isompi kaloritavoite tai henkilömäärä kasvattaa tarpeen yli pakkausrajan, listalle tulee automaattisesti toinen paketti. Kappaletavarat (tortillat, munat, leivät, letut...) annostellaan tasan: jokaiseen annokseen tulee sama kokonaismäärä (esim. 2 tortillaa/annos) ja kalorit joustavat vastaavasti hieman päivien välillä — reseptikortti näyttää määrän myös per annos. Reseptikortti näyttää pakkausraaka-aineet kokonaisina paketteina ("2 pkt (400 g) Jauhelihaa — käytä kokonaan"): satsi valmistetaan koko paketeista ja annoskoko joustaa hieman, joten jämiä ei jää. Kananmunien ja tortilloiden kaltaiset kappaletavarat pyöristetään ylöspäin tarpeen mukaan. Pakkauskoot määritellään index.html:n PACK-taulukossa.
